...
Future<DateTime?> customShowDatePicker({
  ...
  return showDialog<DateTime>(
    context: context,
    barrierDismissible:  preventOutTouch,
...
///
/// It is used internally by [customShowDatePicker] or can be directly pushed
/// onto the [Navigator] stack to enable state restoration. See
/// [customShowDatePicker] for a state restoration app example.
///
/// See also:
///
///  * [customShowDatePicker], which is a way to display the date picker.
...
/// See also:
///
///  * [customShowDatePicker], which shows a material design date picker used to
